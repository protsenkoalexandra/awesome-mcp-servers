...
- <img src="https://pasteapp.io/favicon.ico" height="14"/> [Paste](https://github.com/pasteapp/paste-mcp)<sup><sup>⭐</sup></sup> - Official MCP server for [Paste](https://pasteapp.io), the Mac clipboard manager. Search clipboard history, use copied items as context, and save AI output to pinboards. Runs locally on-device.
